import 'package:bookly_app/Features/home_page/data/manger/similar_books_cubit/similar_books_cubit.dart';
import 'package:bookly_app/Features/home_page/data/repos/home_repo_imp.dart';
import 'package:bookly_app/Features/home_page/presentation/widgets/book_rating.dart';
...
class ViewAllNewestBooks extends StatefulWidget {
  const ViewAllNewestBooks({super.key});

  @override
  State<ViewAllNewestBooks> createState() => _ViewAllNewestBooksState();
}

class _ViewAllNewestBooksState extends State<ViewAllNewestBooks> {
  int currantIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('All Books 📚', style: StyleManger.textStyle22),
      ),
      body: BlocProvider(
        create:
            (context) =>
